...
var (
	...
	// nolint: lll
	expiryRE    = regexp.MustCompile(`(?i)(Valid Until|Expire Date|Registry Expiry Date|paid-till|Expiration Date|Expiration Time|Expiry date|Expiry|Expires On|expires|Expires|expire|Renewal Date|Record expires on|Expiry Date)\]?:?\s?(.*)`)
